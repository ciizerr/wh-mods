...
*   **Neko Key (Boss Key):** Set a custom keyboard shortcut to instantly hide all your cats and mute their sounds when you need to focus (or when the boss walks by).
